...
class UpperEllipse extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path0.quadraticBezierTo(size.width * 0.6, size.height * 0.15, size.width, size.height * 0.13);
...
class LowerEllipse extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path0.quadraticBezierTo(size.width * 0.28, size.height * 0.7, 0, size.height * 0.5);
...
class OneThirdScreenCoverEllipse extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path0.quadraticBezierTo(size.width * 0.5, size.height * amount, 0, size.height * 0.3);
    path0.close();
    return path0;
  }
...
class Shape2 extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path0.moveTo(0, size.height);
    path0.lineTo(size.width, size.height);
    path0.lineTo(size.width, size.height * 0.6);
    path0.quadraticBezierTo(
        size.width * 0.8, size.height * 0.1, size.width * 0.5, size.height * 0.5);
    path0.quadraticBezierTo(size.width * 0.2, size.height * 0.98, 0, 0);
    path0.close();
    return path0;
  }
...
class OnlyBottomEllipse extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path0.lineTo(size.width, size.height);
    // path0.lineTo(size.width, size.height * 0.3);
    path0.quadraticBezierTo(size.width * 0.5, size.height * amount, 0, size.height);
    path0.close();
    return path0;
  }
