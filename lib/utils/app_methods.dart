...
class AppMethods {
  ...
  static Future<String?> fileExtensionFromDownloadUrl({required String downloadUrl}) async {
    final List<String> splitted1 = downloadUrl.split("%2F");
    final List<String> splitted2 = splitted1[1].split("?");
    final childId = splitted2[0];
    final ref = FirebaseStorage.instance.ref("previousReports").child(childId);
