                                  ...
                                  children: [
                                    MouseRegion(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: const CategoryItem('assets/images/book_appoint.png',
                                            'Book An Appointment', Color(0xFF028E81)),
                                      ),
                                    ),
                                    MouseRegion(
                                      cursor: SystemMouseCursors.click,
                                    ...
                                    MouseRegion(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          Navigator.of(context)
                                              .pushNamed(MyScheduleScreen.routeName);
                                        },
                                        child: const CategoryItem('assets/images/calender.jpg',
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: const CategoryItem(
                                          'assets/images/feet.png', 'Flat Feet', Color(0xFFFF9800)),
                                    ),
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).pushNamed(KnockKneeScreen.routeName);
                                      },
                                      child: const CategoryItem('assets/images/knee.jpg',
                                          'Knock Knee', Color(0xFF3F51B5)),
                                    ),
                                  ],
                                ),
                              ),
